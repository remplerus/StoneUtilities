...
public class StoneItems {
    ...
    public static final RegistryObject<Item> STONE_TORCH = ITEMS.register("stone_torch",
            () -> new StandingAndWallBlockItem(StoneBlocks.STONE_TORCH.get(), StoneBlocks.WALL_STONE_TORCH.get(), TAB));
    ...
    public static final RegistryObject<Item> STONE_HELMET = ITEMS.register("stone_helmet",
            () -> new ArmorItem(StoneArmorMaterial.STONE, EquipmentSlot.HEAD, new Item.Properties().tab(StoneUtilities.TAB).durability(StoneConfig.getHelmetDurability())));
    public static final RegistryObject<Item> STONE_CHESTPLATE = ITEMS.register("stone_chestplate",
            () -> new ArmorItem(StoneArmorMaterial.STONE, EquipmentSlot.CHEST, new Item.Properties().tab(StoneUtilities.TAB).durability(StoneConfig.getChestplateDurability())));
    public static final RegistryObject<Item> STONE_LEGGINGS = ITEMS.register("stone_leggings",
            () -> new ArmorItem(StoneArmorMaterial.STONE, EquipmentSlot.LEGS, new Item.Properties().tab(StoneUtilities.TAB).durability(StoneConfig.getLeggingsDurability())));
    public static final RegistryObject<Item> STONE_BOOTS = ITEMS.register("stone_boots",
            () -> new ArmorItem(StoneArmorMaterial.STONE, EquipmentSlot.FEET, new Item.Properties().tab(StoneUtilities.TAB).durability(StoneConfig.getBootsDurability())));
